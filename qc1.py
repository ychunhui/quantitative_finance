...
class portfolio:
    ...
    def __init__(self, data, ledger_data):
        ...
        self.optimized_ledger = self.build_optimal_ledger(ledger_data)
    ...
    # Function to calculate balances
    def build_optimal_ledger(self, port):

        ledger = pd.DataFrame()

        # Calculate trade activity
        for nm, grp in port.groupby('ticker'):
            
            amount = 10000
            
            weight = self.optimal_risky_port[nm]
